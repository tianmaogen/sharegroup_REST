...
import com.sharegroup.rest.exception.ErrorResponse;
import com.sharegroup.rest.utils.AuthenticationMode;
...
public final class RestClient {
	...
	public <T> T call(String methodName, String restPath, Class<T> expectedResponse, Object payload,
		...
		Integer statusCode = result.getStatusInfo().getStatusCode();
		if (result != null && result.hasEntity() && isStatusCodeOK(result, restPath) && 200 == statusCode) {
