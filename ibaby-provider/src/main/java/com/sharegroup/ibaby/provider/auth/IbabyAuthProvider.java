...
package com.sharegroup.ibaby.provider.auth;
 ...
 * @author Matt Tucker
 */
public class IbabyAuthProvider implements AuthProvider {
    ...
    public void authenticate(String username, String password) throws UnauthorizedException {
        ...
        try {
            Log.info("in:"+password);
            Log.info("out:"+getPassword(username));
    ...
    public String getPassword(String username) throws UserNotFoundException {
        ...
        if(!"admin".equals(username) && !"ibaby".equals(username)){
            MSApiService service = new  MSApiServiceImpl();
